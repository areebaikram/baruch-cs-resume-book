...
2. Open `README.html` inside the folder. It has the full instructions.
...
| File | What it is |
|---|---|
| `README.html` | Student instructions. Start here. |
